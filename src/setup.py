...
cpp_files = [
    "py_engine.cpp",
    "engine.cc", # Your original implementation file
    # engine.h is included automatically by the compiler
]
...
setup(
    name="py-engine",
    version="0.1.0",
    description="Python wrapper for the C++ Value micrograd engine.",
    author="Philip Park",
